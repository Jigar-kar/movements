...
import 'package:moments/admin/acategory/Aframe.dart';
...
class AddFrameData extends StatefulWidget {
  @override
  State<AddFrameData> createState() => _AddFrameDataState();
}

class _AddFrameDataState extends State<AddFrameData> {
  ...
  final List<Map<String, dynamic>> products = [
    ...
    },
    {
      ...
      'page': AFream(), // Define the page to navigate to
    },
  ];
