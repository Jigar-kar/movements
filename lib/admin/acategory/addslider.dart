...
class AddSliderDialog extends StatefulWidget {
  ...
  @override
  _AddSliderDialogState createState() => _AddSliderDialogState();
}

class _AddSliderDialogState extends State<AddSliderDialog> {
  ...
  Widget build(BuildContext context) {
    return LoaderOverlay(
      ...
      child: AlertDialog(
        title: Text('Add Slider for ${widget.title}'),
  ...
  void _uploadDataAndImages(BuildContext context) async {
    ...
    try {
      ...
      String documentFolderName = widget.documentId;
